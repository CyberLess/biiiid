...
var notifications = {
	...
	setMessagesToggleListeners: () => {
		notifications.$toggleMessages.click(() => {
			...
			notifications.$bottomWrap.removeClass(
	...
	openMessages: (evt) => {
		...
		notifications.$body
			...
			.click(notifications.closeMessages);
		notifications.$notifications
			.children()
			.click(notifications.onNotificationsChildrenClick);
	},
	...
	openNotifications: (evt) => {
		...
		notifications.$body
			.children()
			.not(notifications.$notifications)
			.click(notifications.closeNotifications);
		notifications.$notifications
			.children()
			.click(notifications.onNotificationsChildrenClick);
	},
